...
from flaskblog.users.utils import save_picture, send_reset_email, delete_previous_img

# from flaskblog.users.
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash("Email has been send. Check you Inbox!", "info")
        return redirect("login")

    return render_template('reset_resquest.html', title="Reset Password", form=form)
